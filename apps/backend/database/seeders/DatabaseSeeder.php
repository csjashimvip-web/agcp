...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->call([IdentitySeeder::class, CommerceSeeder::class, SupplierSeeder::class, RulesFraudSeeder::class, SaasPluginSeeder::class, PaymentSeeder::class, EngagementOperationsSeeder::class, ReportingSeeder::class]);
    }
}
